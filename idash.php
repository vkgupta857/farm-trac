                ...
                <div class="card w-100">                    
                    <div class="card-header text-center">
                        <ul class="nav nav-pills justify-content-between" role="tablist">
                            <li class="nav-item pt-2 mr-3"><b>Welcome, <?php echo $_SESSION['industrialist']; ?> </b></li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#tab-search" data-toggle="tab">Search Farmers</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="card-body w-100">
                        <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="row w-100">
                                    ...
                                    <div class="col-md-8">
                                        <table class="table">
                                            <tbody>
                                                <?php
                                                $query = "Select * from industrialist where i_id='" . $_SESSION['industrialist'] . "'";
                                ...
                                <div class="row">
                                    <table class="table table-responsive">
                                        <tbody>
                                            ...
                                            <?php
                                            $fertilizers = "";
                                            $query = "Select * from productreg P inner join industrialist F on P.r_id=F.i_id where r_id='" . $_SESSION['industrialist'] . "' order by cast(substr(P.p_id,2)as INT) ";
                            ...
                            <div class = "tab-pane fade show" id = "tab-search" role = "tabpanel" aria-labelledby = "tab-search">
                                <h5 class="text-center">Search for Farmers</h5>
                                <div class="row text-center">
                                    <div class="card-body">
                                        <form method="post" action="search_product.php">
                                            <div class="form-group row">
                                                <label for="search" class="col-form-label col-md-4 text-right">Search Product</label>
                                                <div class="col-md-4">
