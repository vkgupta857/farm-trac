<nav class="navbar navbar-expand-md fixed-top navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="index.php"><b>Trac</b></a>
        ...
        <div class="collapse navbar-collapse" id="nav1">
            <ul class="navbar-nav ml-auto">
                ...
                <?php if (isset($_SESSION['farmer']) || isset($_SESSION['mediocre']) || isset($_SESSION['industrialist'])) { ?>
                    <li class="nav-item">
                ...
                <?php } ?>
                    <li class="nav-item">
                        <a class="nav-link" href="contact.php"><b>Ask Expert</b></a>
                    </li>
            </ul>
        </div>
    </div>
