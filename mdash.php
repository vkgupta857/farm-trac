        ...
        <div class="container">
            <div class="row text-center">
                <div class="card w-100">
                    <div class="card-header">Search for industries</div>
                    <div class="card-body">
                        <form method="post" action="">
                            <div class="form-group row">
                                <label for="search" class="col-form-label col-md-4">Search Industries</label>
                                <div class="col-md-4">
                                    <input class="form-control form-control-sm" name="search" type="text" required=""/>
                                </div>
                                <div class="col-md-2">
                ...
                <div class="card w-100">                    
                    <div class="card-header text-center">
                        <ul class="nav nav-pills justify-content-between" role="tablist">
                            <li class="nav-item pt-2 mr-3"><b>Welcome, <?php echo $_SESSION['mediocre']; ?> </b></li>
                            <li class="nav-item">
                                ...
                                <div class="row w-100">
                                    ...
                                    <div class="col-md-8">
                                        <table class="table">
                                            <tbody>
                                                <?php
                                                $query = "Select * from mediocre where m_id='" . $_SESSION['mediocre'] . "'";
                                ...
                                <div class="row">
                                    <table class="table table-responsive">
                                        <tbody>
                                            ...
                                            <?php
                                            $fertilizers = "";
                                            $query = "Select * from productreg P inner join mediocre F on P.r_id=F.m_id where r_id='" . $_SESSION['mediocre'] . "' order by cast(substr(P.p_id,2)as INT) ";
                                            $products = $con->query($query);
                                            while ($product = $products->fetch_assoc()) {
                                                $filename = $PNG_TEMP_DIR . $product['p_id'] . ".png";
                                                $query2 = "Select * from ingredient where p_id='" . $product['p_id'] . "'";
                                ...
                                <div class="row">                                    
                                    ...
                                    <div class="col-md-8 offset-md-2">
                                        <form action="" method="post" class=" w-100">
                                            ...
                                            <div class="form-group row">
                                                <label for="location" class="col-sm-4 col-form-label">Duration</label>
                                                <div class="col-sm-8">
                                    ...
                                    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_product'])) {
                                        ...
                                        if (isset($_POST['expiry'])) {
                                            $expiry = $_POST['expiry'];
                                            $duration = "";
                                            $query = "Insert into productreg values('$p_id','$regBy','$r_id','$p_name','$qty','$category',sysdate(),'$duration','$expiry')";
                                        } else {
                                            $duration = $_POST['duration'];
                                            $expiry = "";
                                            $query = "Insert into productreg values('$p_id','$regBy','$r_id','$p_name','$qty','$category',sysdate(),'$duration',DATE_ADD(sysdate(), INTERVAL 3 MONTH))";
                                        }
